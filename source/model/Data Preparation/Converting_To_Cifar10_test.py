...
for dirname, dirnames, filenames in os.walk('/Users/Nidhi/PycharmProjects/PracticeAI/Altering Images/data/test'):
...
output_file = open('cifar10-ready-testData.bin', 'wb')
